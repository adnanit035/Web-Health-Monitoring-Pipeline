...
def lambda_handler(event, context):
    ...
    for url in constants.URL_TO_MONITOR:
        ...
        cloudWatch.publish_metrics(constants.AVAIL_METRIC_NAME, constants.ORION_URL_NAME_SPACE, dimensions, avail)
        
        # latency of my resource
        latency = calc_latency(url)
        
        cloudWatch.publish_metrics(constants.LATENCY_METRIC_NAME, constants.ORION_URL_NAME_SPACE, dimensions, latency)
